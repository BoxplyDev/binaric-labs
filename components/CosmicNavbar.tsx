            ...
            <div className="flex items-center justify-between h-16 relative">
              ...
              <Link href="/">
                ...
                >
                  {/* Wordmark */}
                  <div>
                    <span className="text-white font-bold tracking-tighter text-base leading-none block">
                      BINARIC
                    </span>
                    <span className="text-white/30 text-[9px] tracking-[0.4em] font-light block">
                      LABS
                    </span>
                  </div>

                  {/* Animated separator on hover */}
                  <motion.div
                    variants={{ hover: { opacity: 1, width: 16 } }}
              ...
              <Link href="/demo">
                ...
                >
                  ...
                  {/* Corner accents — materialise on hover */}
                  {[
                    ...
                    <motion.div
                      ...
                      className={`absolute w-2 h-2 border-white/60 ${pos}`}
                    />
                  ))}
                  ...
                  <div className="relative flex items-center gap-3">
                    <span className="text-white/80 text-[11px] tracking-[0.25em] uppercase font-light">
                      Book a Demo
                    </span>
                    <motion.div
                      variants={{ hover: { x: 3, rotate: 45 } }}
                ...
                <Link href="/demo">
                  ...
                  >
                    <div className="flex items-center justify-between px-4">
                      <span className="text-white/70 text-[11px] tracking-[0.25em] uppercase font-light">
                        Book a Demo
                      </span>
